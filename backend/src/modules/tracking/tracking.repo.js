...
export const getTrackingHistoryFromDB = async (driverId, date) => {
    const query = `
...
export const getTrackingHistoryByOrder = async (driverId, date, orderId) => {
    const query = `
...
export const saveLocationToDB = async ({ driverId, lat, lng, order_id }) => {
    const query = `
