...
export default function RestaurantReviewPage() {
    ...
    const avgRatingNumber = totalReviews > 0 ? (reviews.reduce((sum, r) => sum + r.rating, 0) / totalReviews) : 0;
                        ...
                        <div key={review.id || index} className={styles.reviewCard}>
                            ...
                            <div className={styles.reviewContent}>
                                <div className={styles.reviewHeader}>
                                    <span className={styles.userName}>{maskUserName(review.user_name)}</span>
                                    <div className={styles.itemRating}>
                                        {review.rating} <Star size={14} fill="#FF6B35" color="#FF6B35" />
                                    </div>
                                </div>
